...
object DyeingEntityRegistry : InitHook() {
	...
	override fun init() {
		register(object : DyeEntityHandler<ItemEntity>(ItemEntity::class.java) {
			override fun validate(entity: ItemEntity, dye: DyeOption): Boolean {
		...
		register(object : DyeEntityHandler<CatEntity>(CatEntity::class.java) {
			override fun validate(entity: CatEntity, dye: DyeOption) = dye != DyeOption.UNCOLORED
		...
		register(object : DyeEntityHandler<WolfEntity>(WolfEntity::class.java) {
			override fun validate(entity: WolfEntity, dye: DyeOption) = dye != DyeOption.UNCOLORED
		...
		register(object : DyeEntityHandler<SheepEntity>(SheepEntity::class.java) {
			override fun validate(entity: SheepEntity, dye: DyeOption) = dye != DyeOption.UNCOLORED
		...
		register(object : DyeEntityHandler<FigureSpecklike>(FigureSpecklike::class.java) {
			override fun validate(entity: FigureSpecklike, dye: DyeOption) = dye != DyeOption.UNCOLORED
