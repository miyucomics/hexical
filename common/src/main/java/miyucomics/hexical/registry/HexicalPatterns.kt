...
object HexicalPatterns {
	...
	fun init() {
		...
		register(HexPattern.fromAngles("awqwaeqqqqq", HexDir.NORTH_EAST), "get_effect", OpGetItemStackData(5))
		...
		register(HexPattern.fromAngles("deewad", HexDir.NORTH_WEST), "modify_block_energized", OpModifyMageBlock("energized", 1))
		...
		register(HexPattern.fromAngles("aqaew", HexDir.NORTH_WEST), "is_sleeping", OpGetLivingEntityData(0))
		register(HexPattern.fromAngles("eaq", HexDir.WEST), "is_sprinting", OpGetLivingEntityData(1))
