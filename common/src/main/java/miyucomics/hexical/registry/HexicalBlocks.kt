...
import miyucomics.hexical.blocks.AkashicTerminalBlock
...
object HexicalBlocks {
	...
	val AKASHIC_TERMINAL_BLOCK: AkashicTerminalBlock = AkashicTerminalBlock()
	...
	@JvmStatic
	fun init() {
		BLOCKS.register("akashic_terminal") { AKASHIC_TERMINAL_BLOCK }
